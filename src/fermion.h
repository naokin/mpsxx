#ifndef __MPSXX_TESTS_FERMION_H
#define __MPSXX_TESTS_FERMION_H
...
public:
  ...
  bool involve (const fermion& x) const { return (p_ == x.p_ && s_ == x.s_); }

  fermion conj () const { return fermion(-p_,-s_); }

  fermion operator+ () const { return fermion(+p_,+s_); }
