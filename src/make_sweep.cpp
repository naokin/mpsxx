...
double mpsxx::make_sweep(const std::vector<double>& E, const mpsxx::DMRGInput& input, const size_t& iroot)
{
  ...
  std::vector<btas::QSTArray<double,4,fermion>> OpSys;
  std::vector<btas::QSTArray<double,4,fermion>> OpEnv;
  ...
  std::vector<std::vector<btas::QSTArray<double,3,fermion>>> lHopr(iroot+1);
  std::vector<std::vector<btas::QSTArray<double,3,fermion>>> rHopr(iroot+1);
...
//    eswp = optimize_onesite_merged(1,E,OpSys,      lHopr,rHopr,lSopr,rSopr,WfMps,WfSys,WfEnv,0.1*T,M,input.noise);
      ...
      eswp = optimize_twosite_merged(1,E,OpSys,OpEnv,lHopr,rHopr,lSopr,rSopr,WfMps,WfSys,WfEnv,0.1*T,M,input.noise);
...
//    eswp = optimize_onesite_merged(0,E,      OpSys,lHopr,rHopr,lSopr,rSopr,WfMps,WfEnv,WfSys,0.1*T,M,input.noise);
      ...
      eswp = optimize_twosite_merged(0,E,OpEnv,OpSys,lHopr,rHopr,lSopr,rSopr,WfMps,WfEnv,WfSys,0.1*T,M,input.noise);
